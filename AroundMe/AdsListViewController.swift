...
class AdsListViewController: UITableViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        print("IN AdsListViewController -----------------------")
        
        let url:String = "http://localhost:3000/api/ads/restaurant"
        RestApiManager.sharedInstance.makeHTTPGetRequest(url, onCompletion: handleRESTCall)
